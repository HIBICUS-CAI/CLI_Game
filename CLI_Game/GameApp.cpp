...
int Init()
{
    ...
    GetUIObjByID(10001)->AddText(UI_TEXT(POSITION_2D(1, 1),
        (char*)"アホアホマン"));
    GetUIObjByName("child")->AddBtn(UI_BUTTON(POSITION_2D(3, 3), (char*)"ボタン1", BTN_DESIGN::LINE));
    GetUIObjByName("child")->AddBtn(UI_BUTTON(POSITION_2D(9, 4), (char*)"ボタン2", BTN_DESIGN::LINE));
    GetUIObjByName("child")->AddBtn(UI_BUTTON(POSITION_2D(10, 7), (char*)"閉じる", BTN_DESIGN::STRAIGHT));
