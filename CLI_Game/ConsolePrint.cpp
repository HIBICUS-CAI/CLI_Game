...
void InitOutputBuffer()
{
    ...
    GetUIObjByName("parent")->AddBtn(UI_BUTTON(POSITION_2D(3, 3), (char*)"開く", BTN_DESIGN::LINE));
    GetUIObjByName("parent")->AddBtn(UI_BUTTON(POSITION_2D(10, 7), (char*)"閉じる", BTN_DESIGN::STRAIGHT));
